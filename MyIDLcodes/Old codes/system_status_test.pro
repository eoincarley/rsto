pro system_status_check,folder
;
;
...
;   
;   Last modified:
;   - 10-Nov-2011 (E.Carley) Added Check for all three receivers
;
;
...
pro system_status_test

system_status_check,'high_freq'
system_status_check,'mid_freq'
system_status_check,'low_freq'
...
close,100
print,'Finished system status check'
