...
pro callisto_hourly_windows_v3, spectra, backg=backg
...
stitch_spectra, '03', z_high, x_high, y_high 
stitch_spectra, '02', z_mid, x_mid, y_mid
stitch_spectra, '01', z_low, x_low, y_low
...
spectro_plot,bytscl(z_high,mean(z_high)-1.5*stdev(z_high),mean(z_high)+12.0*stdev(z_high)),x_high,y_high,/xs,/ys,$
